  ...
  module USCoreV200
    class USCoreTestSuite < Inferno::TestSuite
      ...
      group do
        ...
        id :us_core_v200_fhir_api

        group from: :us_core_v200_capability_statement
      
        group from: :us_core_v200_device
        group from: :us_core_v200_explanation_of_benefit
        group from: :us_core_v200_medication_dispense
        group from: :us_core_v200_provenance
